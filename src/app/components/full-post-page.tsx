...
export default async function FullPagePostView(props: { postId: number }) {
  ...
  return <BulletCardModal subjectName={post.subjectName} fiveGoodThings={postThings} agreeCount={post.agreeCount} disagreeCount={post.disagreeCount} userId={post.userId} dateCreated={post.createdAt} key={post.id} />;
}